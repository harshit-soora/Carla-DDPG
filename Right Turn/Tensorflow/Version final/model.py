...
class DDPG:
	...
	def __init__(self, action_space, state_space, radar_dim, type):
		...
		self.upper_bound = 0.4 # Right Turn limit
		self.epsilon = 0.8
		self.gamma = .99
		self.batch_size = 64
		self.epsilon_min = .1
	...
	def __process_state(self):
		...
		radar_out5 = layers.Dense(128, activation="relu")(radar_out4)
		...
		return radar_input, state_input, state_out4

	def get_actor(self):
		# Initialize weights
		last_init = tf.random_uniform_initializer(minval=-0.004, maxval=0.004)
		
		concat_out1 = layers.Dense(128, activation="relu")(self.state_concat)
		concat_out2 = layers.BatchNormalization()(concat_out1)
		concat_out3 = layers.Dense(64, activation="relu")(concat_out2)
	...
	def get_critic(self):
		...
		action_out1 = layers.BatchNormalization()(action_out0)
		action_out2 = layers.Dense(8, activation="relu")(action_out1)
		action_out3 = layers.BatchNormalization()(action_out2)

		# Both are passed through seperate layer before concatenating
		concat = layers.Concatenate()([self.state_concat, action_out3])

		out1 = layers.Dense(128, activation="relu")(concat)
		out2 = layers.BatchNormalization()(out1)
		out3 = layers.Dense(64, activation="relu")(out2)
