...
class CarlaVehicle(object):
	...
	def step_straight(self, action, p):
		...
		return data[-4*LIMIT_RADAR:], [round(kmh, ROUNDING_FACTOR), round(location.y, ROUNDING_FACTOR)] , reward, done, None
